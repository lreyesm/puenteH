...
MODEL           = DAtosInOut_PRBS
MODULES         = rt_matrx.c rt_printf.c rt_logging.c DAtosInOut_PRBS_capi.c DAtosInOut_PRBS_data.c DAtosInOut_PRBS_xcp.c DAtosInOut_PRBS_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = DAtosInOut_PRBS.mk
...
MODELLIB                  = DAtosInOut_PRBSlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = DAtosInOut_PRBS_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\DAtosInOut_PRBS_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
